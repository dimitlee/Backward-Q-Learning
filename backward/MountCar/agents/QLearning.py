...
def QLearning(env, learn_st, test_st, learning=0.5, discount=0.99, back=False):
    # Initialize Q table
    ...
    reached = 0
    # Run Q learning algorithm: Learning phase
    while reached < 300:
        ...
        while done != True:
            ...
            # action = eps_greedy(state_adj[0], state_adj[1], Q)
    ...
    tot_episodes = 0
    reached = 0
    # Run Q learning algorithm: Testing phase
    while reached < 40:
        # Initialize parameters
        done = False
        tot_reward, reward = 0,0
